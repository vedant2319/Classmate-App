...
class _StudentRegisterState extends State<StudentRegister> {
  ...
  Future<void> _register(BuildContext context) async {
    ...
    try {
      ...
      QuerySnapshot regNoSnapshot = await FirebaseFirestore.instance
          .collection("students")
          .where("Reg No", isEqualTo: regNo)
          .get();
      if (regNoSnapshot.docs.isNotEmpty) {
        if (context.mounted) {
          Navigator.of(context).pop(); // Dismiss loading dialog
          showMessage(context, "This Registration is Already Done!");
          return;
        }
      }
      ...
      if (emailSnapshot.docs.isNotEmpty) {
        if (context.mounted) {
          Navigator.of(context).pop(); // Dismiss loading dialog
          showMessage(context, "Email is already Registered!");
          return;
        }
      }
      ...
      if (userCredential.user != null) {
        ...
        if (context.mounted) {
          showDialog(
            ...
            builder: (BuildContext context) {
              return AlertDialog(
                title: const Text("Yay!! Successfully Registered!!"),
                content:
  ...
  Future<void> _uploadProfilePhoto(
    ...
    // Create a new document in Firestore for the student
