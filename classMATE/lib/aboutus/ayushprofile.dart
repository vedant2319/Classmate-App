...
class AyushProfile extends StatelessWidget {
  const AyushProfile({super.key});
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            const CircleAvatar(
              radius: 100,
              backgroundImage: AssetImage('assets/profilephoto/Ayush.jpg'),
            ),
            const SizedBox(height: 20),
            const Text(
              'Ayush Sunil Bansod',
