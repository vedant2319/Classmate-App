...
class HarshProfile extends StatelessWidget {
  const HarshProfile({super.key});
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            const CircleAvatar(
              radius: 100,
              backgroundImage: AssetImage('assets/profilephoto/Harsh.jpg'),
            ),
            const SizedBox(height: 20),
            const Text(
              'Harsh Umesh Bhingarde',
